...
try{
    ...
    $link = new \PDO(   'mysql:host=localhost;dbname=u415020159_mantizb;charset=utf8mb4', //'mysql:host=localhost;dbname=canvasjs_db;charset=utf8mb4',
                    ...
                    $handle = $link->prepare('SELECT  p.nombre_proyecto as nom_proyecto, a.usuario,a.proyecto, valor3,COUNT(valor3) AS VAL from auditoria a inner join proyecto p on a.proyecto=p.codigo where valor3=0 GROUP BY proyecto,valor3'); 
                    $handle->execute(); 
                    ...
                    $handle2 = $link->prepare('SELECT  p.nombre_proyecto as nom_proyecto, a.usuario,a.proyecto, valor3,COUNT(valor3) AS VAL from auditoria a inner join proyecto p on a.proyecto=p.codigo where valor3=2 GROUP BY proyecto,valor3'); 
                    $handle2->execute(); 
