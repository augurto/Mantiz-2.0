        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        ...
                        <?php 
                        $count=1;
                        foreach ($link->query('SELECT * from proyecto where estado=0 order by fecha_fin desc') as $row){ // aca se hace la consulta e iterarla con each. ?> 
                        <?php
                        ...
                        $estado=$row['estado'];
                         if ($fecha_actual<$fecha2) { ?>
                             ...
                             <?php  } else{?>
                             <tr style="background-color: blue !important; opacity:0.5;">
                             <?php }?>   
