    ...
    ?>      
            ...
            if ($estado_entregable==0) { ?>
              ...
              <?php } ?>
                  ...
                  <div align="center"><a href="archivos/<?php echo  $id_p  ; ?>/<?php echo  $documento; ?>" download="archivos/<?php echo  $id_p  ; ?>/<?php echo  $documento; ?>"><i class="fa fa-download"></i> <?php echo $documento; ?></a></div>
