    ...
    ?>      
              ...
              <div class="card shadow mb-4">
               ...
               <!--  condicional para colorear el div de arriba -->
                ...
                <select class="form-select .text-primary" style="border-color: #0275d8 !important; background-color: 
                <?php if ($estado_entregable==0) {echo '#FFF0F5';}elseif ($estado_entregable==1) {echo '#F0FFF0'; }else {echo '#FFF0F5';}?> !important;"  aria-label="Example select with button addon" id="estado_entregable1" name="estado_entregable1">
