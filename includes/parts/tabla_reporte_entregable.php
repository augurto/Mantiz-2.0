        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        ...
                        foreach ($link->query('SELECT DISTINCT * from archivos a inner join entregables e on a.a_codigo_proyecto=e.codigo_proyecto inner join proyecto p on a.a_codigo_proyecto = p.codigo order by a_id desc') as $row){ // aca se hace la consulta e iterarla con each. ?> 
