        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        ...
                        <?php 
                        $count=1;
                        foreach ($link->query('SELECT * from entregables e inner join proyecto p on e.codigo_proyecto = p.codigo inner join archivos a on e.codigo_proyecto = a.codigo_proyecto order by codigo desc') as $row){ // aca se hace la consulta e iterarla con each. ?> 
                        <?php
