        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        ...
                        foreach ($link->query('SELECT * from archivos a inner join entregables e on a.codigo_proyecto=e.codigo_proyecto inner join proyecto p on a.codigo_proyecto = p.codigo order by id_seg desc') as $row){ // aca se hace la consulta e iterarla con each. ?> 
