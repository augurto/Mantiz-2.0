...
<div class="row">
          ...
          <?php
                ...
                <tr>
                    ...
                    <div class="progress">
                      <div class="progress-bar progress-bar-striped bg-info" role="progressbar" style="width: 50%" aria-valuenow="<?php echo $porcentaje_entregable;?>" aria-valuemin="0" aria-valuemax="100"><?php echo $porcentaje ;?>/<?php 
