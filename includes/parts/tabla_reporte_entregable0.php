        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        ...
                        <?php 
                        $count=1;
                        foreach ($link->query('SELECT * from archivos a right join entregables e on a.id_seg=e.id inner join proyectos p on a.a_codigo_proyecto=p.codigo where a.id_seg IS NULL order by a_id desc') as $row){  ?> 
